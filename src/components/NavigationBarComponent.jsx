...
// Composant Logo avec effet de fond
const LogoWithBackground = ({ activeItem, currentLocation, hasChildren }) => (
...
// Composant DesktopMenu
const DesktopMenu = ({ activeItem, navigate }) => (
...
const MobileMenu = ({ mobileOpen, toggleMenu, navigate }) => {
  ...
  const handleItemClick = (link) => {
    toggleMenu(); // Fermer le menu d'abord
    navigate(link); // Puis naviguer
  };
...
// Composant principal NavigationBar
const NavigationBar = () => {
    ...
    <>
      ...
      >
        <div className="w-full flex justify-between items-center gap-4 select-none">
          ...
          <DesktopMenu activeItem={activeItem} navigate={navigate} />
